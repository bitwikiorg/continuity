...
*This file IS the hard limits and pre-action checklist. Read before any infrastructure or external action. The dangerous commands table defines what requires explicit approval.*
